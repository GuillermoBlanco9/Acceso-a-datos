...
public class AppRenova2Coop2 {
	public static void main(String[] args) {
		AppRenova2Coop2 appRenovaCoop = new AppRenova2Coop2();
	...
	private void pruebasGrupoTrabajoAreaCooperativaHibernate() {
	    ...
	    GrupoTrabajo grupoTrabajo1= null;
	    try {
	    	...
	    	grupoTrabajo1= iGrupoTrabajo.getEntidadPorID(codigoGrupoTrabajo);	 	    	
		} catch (Renova2CoopException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}	
	    ...
	    areasComunicacionGrupoTrabajo1.add(areaCooperativa1);
	    grupoTrabajo1.setAreasCooperativa(areasComunicacionGrupoTrabajo1);
	    ...
	    gruposTrabajoAreaComunicacion1.add(grupoTrabajo1);
	    ...
	    try {
	    	// SE crea el Grupo de Trabajo (así como el Area Cooperativa, y su relación)
	    	iGrupoTrabajo.actualizar(grupoTrabajo1);
		} catch (Renova2CoopException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}	
