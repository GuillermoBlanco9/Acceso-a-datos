...
public class AccesoHibernate implements IoperacionesBBDD<Acceso> {
	...
	public void crear(Acceso entidad) {
		...
		try {
			...
			System.out.println("El acceso ya existe en la base de datos");
		}
		finally {
			session.close();
		}
	...
	public void modificar(Acceso entidad) {
		...
		try {
			...
			System.out.println("El acceso no existe en la base de datos");
		}
		finally {
			session.close();
		}
